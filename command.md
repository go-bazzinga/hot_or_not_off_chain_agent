...
gcloud iam workload-identity-pools describe "receive-canister-metrics" \
  --project="hot-or-not-monitoring" \
  --location="global" \
  --format="value(name)"

projects/431003668404/locations/global/workloadIdentityPools/receive-canister-metrics
...
gcloud iam workload-identity-pools providers describe "github-action" \
  --project="hot-or-not-monitoring" \
  --location="global" \
  --workload-identity-pool="receive-canister-metrics" \
  --format="value(name)"

projects/431003668404/locations/global/workloadIdentityPools/receive-canister-metrics/providers/github-action
```
